...
class Node:
    def __init__(self, itemstring, param0 = 0, param1 = 0, param2 = 0, pos = Pos(0, 0, 0)):
        self.pos = pos
        self.itemstring = itemstring
        self.param0, self.param1, self.param2 = param0, param1, param2
